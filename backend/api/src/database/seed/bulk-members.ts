/**
 * Bulk member generator (dev/staging utility — NOT part of `db:seed`).
 *
 * Creates N fully-populated member accounts: a login user, a member profile
 ...
 * are skipped. Prints a credentials table at the end.
 *
 * Run against any database via its DATABASE_URL:
 *   pnpm --filter @superdreams/api exec tsx src/database/seed/bulk-members.ts [count]
 */
...
const SHARED_PASSWORD = 'Member123!';
const USD = 'USD';
