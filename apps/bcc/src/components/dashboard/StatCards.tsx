...
/**
 * Row of summary statistic cards backed by the real reporting KPIs. Points/rewards
 * only — the monetary "Wallet float" KPI is intentionally not shown (Super Dreams
 * communicates points, not currency). `kpis.walletAvailableMinor` still exists on
 * the API and is simply not surfaced here.
 */
