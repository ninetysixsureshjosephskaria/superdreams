...
/**
 * Route protection backed by the real session. Unauthenticated visitors are
 * redirected to the login page (preserving where they were headed); an
 * authenticated user lacking a required permission gets the 403 page.
 */
